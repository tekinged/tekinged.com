...
function real_button_as_link($config) {
    ...
    echo "Making a button for $config";
...
Class Entry {
    ...
    function addSynonyms() {
      $id = $this->id;
      $q  = "select word from synonyms where grouping in (select grouping from synonyms where word=$id) and word !=$id";
      $r = query_or_die($q);
    ...
    <div id='menuwrapper' onclick=''>
        <ul>
            ...
            <li><a href='#'>More</a>
                ...
                <li><a href='/misc/recent.php'>Recent Changes</a></li>
      ...
      echo "
        ...
        echo "
          <div id='footer'>
            ...
            <!-- As of July 14, 2015, sponsored by and approved by the <a href=http://palaulanguagecommission.blogspot.com>Palau Language Commission</a>.  <br> -->
